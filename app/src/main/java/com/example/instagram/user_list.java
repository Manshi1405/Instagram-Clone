            ...
            try {
                ...
                object.saveInBackground(new SaveCallback() {
                    ...
                    public void done(ParseException e) {
                        if(e==null) {
                            Toast.makeText(user_list.this, "Image Posted", Toast.LENGTH_SHORT).show();
                        }
                        else {
                            Toast.makeText(user_list.this, "There was a error posting image", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
                Log.i("INfo------->","Image Selected");
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
